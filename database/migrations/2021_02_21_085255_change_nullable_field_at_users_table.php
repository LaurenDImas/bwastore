...
class ChangeNullableFieldAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('addressOne')->nullable()->change();
            $table->longText('addressTwo')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('addressOne')->nullable(false)->change();
            $table->longText('addressTwo')->nullable(false)->change();
